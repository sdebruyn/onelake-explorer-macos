...
// architecture flip The host app communicates with it
...
@objc public protocol OfemClientControlProtocol {
    ...
    /// app performs the MSAL interactive call itself func notifyAuthComplete(sessionID: String, reply: @escaping (Error?) -> Void)
