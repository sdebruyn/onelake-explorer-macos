...
struct FabricRequestTests {
    ...
    func requestMethod() throws {
        let url = try fabricListURL(base: try #require(URL(string: "https://api.fabric.microsoft.com")), path: "/v1/workspaces")
    ...
    func requestURL() throws {
        let url = try fabricItemURL(base: try #require(URL(string: "https://api.fabric.microsoft.com")), path: "/v1/workspaces/ws1/items/it1")
        let req = fabricRequest(method: "GET", url: url)
